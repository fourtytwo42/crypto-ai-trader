# Experiment 030 - Filtered tokens + high threshold

## Goal
Test a larger label threshold to focus on stronger moves.

## Setup
- Model dir: `models_pumpfun_classifier_exp30`
- Horizon: 10 minutes
...
./venv/bin/python -m src.main pumpfun-classify-train \
  ...
  --epochs 12 --batch-size 512 --learning-rate 1e-3 --label-threshold 0.02 \
...
## Results
- Train validation accuracy: `82.41%`
- Holdout (12 tokens): `84.54%` (samples=5000)

## Notes
- High threshold reduced accuracy.
