...
from pumpfun_train.data import PUMPFUN_FEATURE_COLUMNS, PUMPFUN_NORMALIZED_COLUMNS
from pumpfun_train.db import get_pumpfun_db_manager
from pumpfun_train.models import PumpCandle1m, PumpToken
...
def predict_pumpfun(
    ...
    confidence = float(1.0 / (1.0 + np.exp(-abs(pred_return) * 8)))
